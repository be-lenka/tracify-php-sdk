...
/**
 * PageViewEvent Class Doc Comment
 *
 * @category Class
 * @package  belenka\tracify
 * @author   OpenAPI Generator team
 ...
 */
class PageViewEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageViewEvent';
    ...
    protected static $openAPITypes = [
        ...
        'datetime' => 'string',
        'type' => 'string',
        'data' => '\belenka\tracify\Model\PageViewEventData'
    ];
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 7)) {
            throw new \InvalidArgumentException('invalid length for $url when calling PageViewEvent., must be bigger than or equal to 7.');
        }
     ...
     * Sets type
     *
     * @param string|null $type A pageview indicates a user visiting a regular page in your website. If you do not send this type, Tracify will try to infer the type by inspecting the url attribute.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \belenka\tracify\Model\PageViewEventData
     */
     ...
     * Sets data
     *
     * @param \belenka\tracify\Model\PageViewEventData $data data
     *
     * @return self
     */
