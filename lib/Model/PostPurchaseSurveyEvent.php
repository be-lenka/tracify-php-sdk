...
/**
 * PostPurchaseSurveyEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class PostPurchaseSurveyEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseSurveyEvent';
    ...
    protected static $openAPITypes = [
        ...
        'datetime' => 'string',
        'type' => 'string',
        'data' => '\belenka\tracify\Model\PostPurchaseSurveyEventData'
    ];
    ...
    public const TYPE_POSTPURCHASESURVEY = 'postpurchasesurvey';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 7)) {
            throw new \InvalidArgumentException('invalid length for $url when calling PostPurchaseSurveyEvent., must be bigger than or equal to 7.');
        }
     ...
     * Gets data
     *
     * @return \belenka\tracify\Model\PostPurchaseSurveyEventData
     */
     ...
     * Sets data
     *
     * @param \belenka\tracify\Model\PostPurchaseSurveyEventData $data data
     *
     * @return self
     */
