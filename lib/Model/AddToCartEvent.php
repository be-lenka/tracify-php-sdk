 ...
 */
class AddToCartEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddToCartEvent';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 7)) {
            throw new \InvalidArgumentException('invalid length for $url when calling AddToCartEvent., must be bigger than or equal to 7.');
        }
