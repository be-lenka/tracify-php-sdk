 ...
 */
class CreateEventsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'events' => '\belenka\tracify\Model\Event[]'
    ];
    ...
    */
     ...
     * Gets events
     *
     * @return \belenka\tracify\Model\Event[]|null
     */
     ...
     * Sets events
     *
     * @param \belenka\tracify\Model\Event[]|null $events events
     *
     * @return self
     */
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling CreateEventsRequest., number of items must be greater than or equal to 1.');
        }
