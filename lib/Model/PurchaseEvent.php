 ...
 */
class PurchaseEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseEvent';
    ...
    protected static $openAPITypes = [
        ...
        'datetime' => 'string',
        'type' => 'string',
        'data' => '\belenka\tracify\Model\PurchaseEventData'
    ];
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 7)) {
            throw new \InvalidArgumentException('invalid length for $url when calling PurchaseEvent., must be bigger than or equal to 7.');
        }
     ...
     * Gets data
     *
     * @return \belenka\tracify\Model\PurchaseEventData
     */
     ...
     * Sets data
     *
     * @param \belenka\tracify\Model\PurchaseEventData $data data
     *
     * @return self
     */
