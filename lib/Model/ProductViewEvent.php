...
/**
 * ProductViewEvent Class Doc Comment
 *
 * @category Class
 * @package  belenka\tracify
 * @author   OpenAPI Generator team
 ...
 */
class ProductViewEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductViewEvent';
    ...
    protected static $openAPITypes = [
        ...
        'datetime' => 'string',
        'type' => 'string',
        'data' => '\belenka\tracify\Model\BaseEventData'
    ];
    ...
    public const TYPE_PRODUCTVIEW = 'productview';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 7)) {
            throw new \InvalidArgumentException('invalid length for $url when calling ProductViewEvent., must be bigger than or equal to 7.');
        }
     ...
     * Gets data
     *
     * @return \belenka\tracify\Model\BaseEventData
     */
     ...
     * Sets data
     *
     * @param \belenka\tracify\Model\BaseEventData $data data
     *
     * @return self
     */
