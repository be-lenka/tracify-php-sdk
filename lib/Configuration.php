...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.tracify.ai';
    ...
    {
        $report  = 'PHP SDK (belenka\tracify) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.tracify.ai",
                "description" => "Production environment",
            ],
            [
                "url" => "https://devapi.tracify.ai",
